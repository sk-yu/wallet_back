...
//modules
property = require('./configs/property');
...
//routes
const usersRouter = require('./routes/user/users');
const ethRouter = require('./routes/wallet/eth');
const ethErc20Router = require('./routes/wallet/ethErc20');

app.use(`${property.apiPrePath}/account`, usersRouter);
app.use(`${property.apiPrePath}/eth`, ethRouter);
app.use(`${property.apiPrePath}/erc20`, ethErc20Router);
